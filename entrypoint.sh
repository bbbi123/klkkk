...
\"add\": \"${ARGO}\",\
\"port\": \"443\",\
\"id\": \"$57cd246e-5a17-467d-9094-f9053622f803\",\
\"aid\": \"0\",\
\"net\": \"ws\",\
\"type\": \"none\",\
\"host\": \"${ARGO}\",\
\"path\": \"/$57cd246e-5a17-467d-9094-f9053622f803-vm\",\
\"tls\": \"tls\",\
\"sni\": \"${ARGO}\"\
}"\
    | base64 -w 0)" 
...
uuid：$57cd246e-5a17-467d-9094-f9053622f803
传输协议：ws
host/sni：$ARGO
path路径：/$57cd246e-5a17-467d-9094-f9053622f803-vm
...
传输协议：ws
host/sni：$ARGO
path路径：/$57cd246e-5a17-467d-9094-f9053622f803-vl
...
https端口：可选443、2053、2083、2087、2096、8443，tls必须开启
http端口：可选80、8080、8880、2052、2082、2086、2095，tls必须关闭
密码：$57cd246e-5a17-467d-9094-f9053622f803
传输协议：ws
host/sni：$ARGO
path路径：/$57cd246e-5a17-467d-9094-f9053622f803-tr
...
传输协议：ws
host/sni：$ARGO
path路径：/$57cd246e-5a17-467d-9094-f9053622f803-ss
...
传输协议：ws
host/sni：$ARGO
path路径：/$57cd246e-5a17-467d-9094-f9053622f803-so
